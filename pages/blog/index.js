        ...
        >
          <div id='main-content'>
            <div className='blog-presentation'>
              <h1>Blog</h1>
              <p>
                Espero que alguno de los siguientes artículos sea de ayuda para tu aprendizaje o
                proyecto. Sentite libre de tomar todo lo que necesités.
              </p>
            </div>
                ...
                >
                  ...
                  >
                    ...
                    <span className='link-date'>
                      {post.frontmatter.date ? post.frontmatter.date : 'Proximamente'}
                    </span>
                  </a>
                </Link>
              ))}
